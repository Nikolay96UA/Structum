...
app.get('/api/attendance/download-excel', async (req, res) => {
    try {
        ...
        usersOnObject.forEach((user, index) => {
            ...
            // Применяем шрифты и выравнивание ко всем финансовым ячейкам строки
        ...
        // Настройка заголовков для отправки файла в браузер
